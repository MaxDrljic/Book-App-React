                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Form.Field error={!!errors.title}>
                                <label htmlFor="field">Book Title</label>
                                <input 
                                    type="text"
                                    id="title"
                                    name="title"
                            ...
                            <Form.Field error={!!errors.authors}>
                                <label htmlFor="field">Book Authors</label>
                                <input 
                                    type="text"
                                    id="authors"
                                    name="authors"
                                    ...
                                    onChange={this.onChange}
                                />
                                {errors.field && <InlineError text={errors.authors} />}
                            </Form.Field>

                            <Form.Field error={!!errors.pages}>
                                <label htmlFor="field">Pages</label>
                                <input 
                                ...
                                />
                                {errors.field && <InlineError text={errors.pages} />}
                            </Form.Field>
                        </Grid.Column>
